...
//	void GuestOut( DWORD OwnerId, CPlayer* pGuest );
	...
	void	InsertStallData(  DWORD dwOwnerIdx, DWORD dwItemIdx, StreetStallFindState State, DWORD dwMoney,DWORD dwGold );//CoNaN 2017-09-16 藤속禱괜송목
	void	DeleteStallData( DWORD dwOwnerIdx, DWORD dwItemIdx, StreetStallFindState State );	// 노점상 검색에 정보 삭제
	DWORD	GetPrice( DWORD dwOwnerIdx, DWORD dwItemIdx, StreetStallPriceState State );	
    DWORD	GetGoldPrice( DWORD dwOwnerIdx, DWORD dwItemIdx, StreetStallPriceState State );  //CoNaN 2017-09-15 삿혤禱괜송목 
