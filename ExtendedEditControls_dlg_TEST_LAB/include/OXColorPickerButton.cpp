...
int COXColorPickerButton::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	{
		if (!m_colorPicker.CreateOne(this, POPUPBAR_NODEFAULT, CreateSolidBrush(RGB(34, 34, 34))))
		{
...
void COXColorPickerButton::PreSubclassWindow() 
{
	...
	if(pThreadState->m_pWndInit==NULL)
	{
		if(!::IsWindow(m_colorPicker.m_hWnd))
		{
			VERIFY(m_colorPicker.CreateOne(this, POPUPBAR_NODEFAULT, CreateSolidBrush(RGB(34, 34, 34))));
		}
	}
