...
//kiv below
#define FOURCC_RGB24		mmioFOURCC('R','G','B',' ')		
#define FOURCC_YV12			mmioFOURCC('Y','V','1','2')		
#define FOURCC_H264			mmioFOURCC('H','2','6','4')		
#define FOURCC_H264_APP		mmioFOURCC('A','P','P',' ')		
#define FOURCC_H264_SYNC	mmioFOURCC('S','Y','N','C')		
#define FOURCC_H264_CUDA	mmioFOURCC('C','U','D','A')		
#define FOURCC_H264_NVENC	mmioFOURCC('N','V','E','N')		
#define FOURCC_AUTO			mmioFOURCC('A','U','T','O')		
#define WAVETAG_AAC			0x00FF							
#define WAVETAG_MP3			0x0055
//kiv end
...
enum 
{
	...
	BCAP_IMAGE_PNG,				// PNG
	BCAP_IMAGE_JPG,				// JPG
	BCAP_IMAGE_CLIPBOARD,
};

// 캡처 설정 구조체
struct BCAP_CONFIG
{
	enum { F_AVI = 0, F_MP4 = 1 };//kiv jack
	enum { V_CBR, V_VBR };
	enum { A_CBR, A_VBR };
	...
	void Default()
	{
		FileType				= F_MP4;//F_AVI;//kiv

		VideoSizeW				= 400;
		VideoSizeH				= 300;
		VideoFPS				= 320.000;

		VideoCodec				= FOURCC_H264;//kiv FOURCC_MPEG;
		...
		AudioCodec				= WAVETAG_AAC;//kiv jack WAVETAG_MP2;
