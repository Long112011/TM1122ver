...
#ifdef _MUTIPET_
			if (PETMGR->IsCurPetFull() && FALSE == PETMGR->IsCurPetSummonItem(pItem->GetDBIdx()))//刀哥  3pet
			{
...
#ifdef _MUTIPET_
		else if (pInfo->ItemIdx == eIncantation_PetMix)//刀哥 3pet
		{
