...
{
	SYSTEMTIME slt = GAMEIN->GetLoginTime();	// 륜麓15쾨.
	m_serverT.SetTime( slt.wYear-2015, slt.wMonth, slt.wDay, slt.wHour, slt.wMinute, slt.wSecond );
}
