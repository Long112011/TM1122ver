...
{
public:  // the attr player time define ! 2014-05-18
...
public:
	...
	virtual float GetRadius()	{	return 100.0f;	}
	...
	virtual BYTE GetStage(){ return 0; }
	virtual void SetStage(BYTE val)	{};
	virtual DWORD GetGuildIdx()	{return 0;}
	virtual MARKNAMETYPE GetGuildMarkName(){return 0;}
