...
#define SPEEDHACK_CHECKTIME	5000
...
enum eReconnectChatFlag
{
	IMAGEMSG,
	CHATMSG,
};
#define MAX_ITEMBUY_NUM		100
#define MAX_INVENTORY_MONEY	4200000000  
...
#define MISSIONRECALL_GROUP_ID	-4
enum eOPTION	
{
	eOPT_NULL		= 0,
	eOPT_NODEAL		= 1,
...
#define RECOVERTIMEUNIT					4000
#define RECOVERINTERVALUNIT				5
...
#define IG_ITEM_STARTINDEX				3000	//12000
#define IG_MUGONG_STARTINDEX			5000	//13000
#define IG_MSGBOX_STRARTINDEX			6000	//14000
#define IG_STREETSTALLITEM_STARTINDEX	7000	//15000
#define IG_EXCHANGEITEM_STARTINDEX		8000	//16000
#define IG_MENUSLOTITEM_STARTINDEX		9000	//17000
#define IG_PKLOOTINGDLG_START			10000	//18000
#define IG_DEBUG_START					15000	//10000	
#define IG_QUESTITEM_STARTINDEX			18000	//15000	
#define IG_SHOPITEM_STARTINDEX			20000	//18000	
#define IG_DEALITEM_START				30000	//20000
#define IG_MAINBARICON_START			31000	//30000
#define IG_ABILITYICON_START			40000	//31000
#define IG_ABILITYPOINT_START			60000	//40000	
...
#define MAX_PACKEDDATA_SIZE 60000 
...
{ 
	...
	eSHOP_ITEM_HERB			= 259,	
	eSHOP_ITEM_INCANTATION	= 260,	
	eSHOP_ITEM_MAKEUP		= 261,	
	eSHOP_ITEM_DECORATION	= 262,	
	eSHOP_ITEM_SUNDRIES		= 263,	
	eSHOP_ITEM_EQUIP		= 264,	
	eSHOP_ITEM_NOMALCLOTHES_SKIN	= 265,	
	eSHOP_ITEM_COSTUME_SKIN			= 266,	
	eSHOP_ITEM_GETIN_ITEM = 267,	//副本
	eSHOP_ITEM_IMAGENAME  = 268,	//称号
	...
	eQUEST_INSDUNGEON_ITEM_USE = 16420,
...
#define MAX_CHARACTER_LEVEL_NUM 200    
#define MAX_PLAYERLEVEL_NUM	200//MAX_CHARACTER_LEVEL_NUM        
#define MAX_TOPLIST_NUM 20            
#define MAX_MONSTERLEVELPOINTRESTRICT_NUM	9
#define MONSTERLEVELRESTRICT_LOWSTARTNUM	6
enum WP_KIND{WP_GUM=1,WP_GWUN,WP_DO,WP_CHANG,WP_GUNG,WP_AMGI,WP_KEY,WP_EVENT,WP_EVENT_HAMMER, WP_AXE, WP_DAGGER,WP_MAX,WP_ERR,WP_WITHOUT=0};
...
#define COMBO_AXE_MIN		52  //axe
#define COMBO_DAGGER_MIN		80 //刺客
...
enum eItemUse_Err
{
	...
	eItemUseErr_NotBoxKey,
	eItemUseErr_MixNotPace=68,
};
#ifdef _SHADE
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _MISSMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _RUBYMSOTWO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _RIOTMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _JSKEN_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _GUMMYMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 500
#elif defined _ORIGIN_
#define MAX_YOUNGYAKITEM_DUPNUM 20
#elif defined _EXMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _CONQMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _RUNUPMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _GENERALMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 100
#elif defined _XIAOMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _FOX_MSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#elif defined _VELESMSO_
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#else
#define MAX_YOUNGYAKITEM_DUPNUM 1000
#endif
...
#define MAX_FRIEND_PAGE MAX_FRIEND_NUM/MAX_FRIEND_LIST 
#define MAX_NOTENUM 40
#define MAX_NOTE_PAGE 4
#define NOTENUM_PER_PAGE MAX_NOTENUM/MAX_NOTE_PAGE 
...
enum CELLPERTAB
{
	...
	//#ifdef _RUNUPMSO_
	//	TABCELL_SHOPINVEN_NUM		= 0,
	//#else
	TABCELL_SHOPINVEN_NUM = MPAGESSLOT,// 40,
//#endif
...
enum
{
	...
	SLOT_WEAR_NUM				= 10,
	SLOT_MUNPAWAREHOUSE_NUM		= TAB_MUNPAWAREHOUSE_NUM * TABCELL_MUNPAWAREHOUSE_NUM,	
	SLOT_PYOGUK_NUM				= TAB_PYOGUK_NUM * TABCELL_PYOGUK_NUM,
	SLOT_QUICK_NUM				= TAB_QUICK_NUM * TABCELL_QUICK_NUM,
	SLOT_ABILITY_NUM			= TAB_ABILITY_NUM * TABCELL_ABILITY_NUM,
	SLOT_QITEMINVEN_NUM			= TAB_QITEMINVEN_NUM * TABCELL_QITEMINVEN_NUM,
	SLOT_GUILDWAREHOUSE_NUM		= TAB_GUILDWAREHOUSE_NUM * TABCELL_GUILDWAREHOUSE_NUM,	
	SLOT_SHOPITEM_NUM			= TAB_SHOPITEM_NUM * TABCELL_SHOPITEM_NUM,
	SLOT_SHOPINVEN_NUM			= TABCELL_SHOPINVEN_NUM,
	...
	SLOT_JINBUB_NUM				= 5,		
	SLOT_TITAN_NUM				= 25,
	SLOT_MUGONGTOTAL_NUM		= SLOT_MUGONG_NUM+SLOT_MUGONG_NUM+SLOT_JINBUB_NUM+SLOT_TITAN_NUM,		
	SLOT_PETINVEN_NUM			= TAB_PET_INVENTORY_NUM * TABCELL_PETINVEN_NUM,	
	SLOT_PETWEAR_NUM			= 3,
	...
	SLOT_CHANGELOOK_NUM	=	20,

	SLOT_CHANGELOOKWEAR_NUM = 7,
};
enum
{
	TP_INVENTORY_START			= 0,
	TP_INVENTORY_END			= TP_INVENTORY_START		+ SLOT_INVENTORY_NUM,
	TP_WEAR_START				= TP_INVENTORY_END,										
	TP_WEAR_END					= TP_WEAR_START				+ SLOT_WEAR_NUM,	
	TP_PYOGUK_START				= TP_WEAR_END,											
	TP_PYOGUK_END				= TP_PYOGUK_START			+ SLOT_PYOGUK_NUM,	
	TP_SHOPITEM_START			= TP_PYOGUK_END,										
	TP_SHOPITEM_END				= TP_SHOPITEM_START			+ SLOT_SHOPITEM_NUM,
	TP_SHOPINVEN_START			= TP_SHOPITEM_END,										
	TP_SHOPINVEN_END			= TP_SHOPINVEN_START		+ SLOT_SHOPINVEN_NUM+TABCELL_SHOPINVEN_PLUS_NUM,
	TP_PETINVEN_START			= TP_SHOPINVEN_END,										
	TP_PETINVEN_END				= TP_PETINVEN_START			+ SLOT_PETINVEN_NUM,		
	TP_PETWEAR_START			= TP_PETINVEN_END,										
	TP_PETWEAR_END				= TP_PETWEAR_START			+ SLOT_PETWEAR_NUM,			
	TP_TITANWEAR_START			= TP_PETWEAR_END,										
	TP_TITANWEAR_END			= TP_TITANWEAR_START		+ SLOT_TITANWEAR_NUM,		
	TP_TITANSHOPITEM_START		= TP_TITANWEAR_END,										
	TP_TITANSHOPITEM_END		= TP_TITANSHOPITEM_START	+ SLOT_TITANSHOPITEM_NUM,	
	TP_MAX						= 540,
	TP_GUILDWAREHOUSE_START		= TP_MAX,
	TP_GUILDWAREHOUSE_END		= TP_GUILDWAREHOUSE_START + SLOT_GUILDWAREHOUSE_NUM,	
	TP_MUGONG1_START			= 600,													
	TP_MUGONG1_END				= TP_MUGONG1_START			+ SLOT_MUGONG_NUM,			
	TP_MUGONG2_START			= TP_MUGONG1_END,										
	TP_MUGONG2_END				= TP_MUGONG2_START			+ SLOT_MUGONG_NUM,			
	TP_JINBUB_START				= TP_MUGONG2_END,										
	TP_JINBUB_END				= TP_JINBUB_START			+ SLOT_JINBUB_NUM,			
	TP_TITANMUGONG_START		= TP_JINBUB_END,										
	TP_TITANMUGONG_END			= TP_TITANMUGONG_START		+ SLOT_TITANMUGONG_NUM,		
	TP_QUICK_START				= 700,													
	...
	TP_CHANGELOOKINVEN_START	= TP_SIEGEFORTWARE_END,
	TP_CHANGELOOKINVEN_END		= TP_CHANGELOOKINVEN_START + SLOT_CHANGELOOK_NUM,
	TP_CHANGELOOKWEAR_START		= TP_CHANGELOOKINVEN_END,
	TP_CHANGELOOKWEAR_END		= TP_CHANGELOOKWEAR_START + SLOT_CHANGELOOKWEAR_NUM,
};
enum eITEMTABLE
{
	...
	eItemTable_Deal,
	eItemTable_Ability,
	eItemTable_ChangeLookInven,
	eItemTable_ChangeLookWear,
	eItemTable_Max,
};
...
enum BASICEFFECT
{
	...
	eEffect_InctanceDungeon_MissionSuccess = 88,
	eEffect_InctanceDungeon_MissionSuccess_Titan = 4088,
};
enum
{
	bukkyung = 1,	
...
enum eMoneyLogtype
{
	...
	eMoneyLog_InstanceDungeonEnter = 210,	
	eMoneyLog_InstanceDungeonRequital = 211,	
	eMoneyLog_InstanceDungeonMissionRequital = 212,
};
enum eLogMugong
{
	eLog_MugongLearn = 0,
...
#define MAX_GUILDMEMBER_NUM 200
enum
{
...
enum
{
	eIncantation_TownMove = 55301,           // 回城符（基础） - 約 5G
	eIncantation_MemoryMove = 55302,         // 回忆传送（基础） - 約 8G
	eIncantation_TownMove15 = 55303,         // 回城符（15次） - 約 70G
	eIncantation_MemoryMove15 = 55304,       // 回忆传送（15次） - 約 110G
	eIncantation_TownMove7 = 57508,          // 回城符（7天） - 約 50G
	eIncantation_TownMove7_NoTrade = 57509,  // 回城符（7天 不可交易） - 約 40G
	eIncantation_MemoryMove7 = 57510,        // 回忆传送（7天） - 約 70G
	eIncantation_MemoryMove7_NoTrade = 57511,// 回忆传送（7天 不可交易） - 約 60G
	eIncantation_MoneyProtect = 55311,       // 金币保护符 - 約 20G
	eIncantation_ExpProtect = 55312,         // 经验保护符 - 約 20G
	eIncantation_ProtectAll = 55313,         // 全保护符 - 約 35G
	eIncantation_StatePoint = 55299,         // 属性点+10 - 約 25YB
	eIncantation_StatePoint_30 = 55321,      // 属性点+30 - 約 60YB
	eIncantation_StatePoint_50 = 57782,      // 属性点+50 - 約 90YB
	eIncantation_StatePoint_100 = 57783,     // 属性点+100 - 約 160YB
	eIncantation_StatusFastAdd = 55392,      // 快速加点符 - 約 15G
	eIncantation_StatusPointReset_71 = 55393,// 属性重置（71以下） - 約 40YB
	eIncantation_StatusPointReset_1_50 = 55393, // 同上
	eIncantation_StatusPointReset_1_99 = 55394,// 属性重置（1-99） - 約 60YB
	eIncantation_SkillPoint_Reset = 55391,   // 技能重置 - 約 60YB
	eIncantation_MixUp = 55322,
	eIncantation_OtherRevive = 55331,
	eIncantation_MemoryStone = 55601,
	eIncantation_SkPointRedist_2 = 55322,    // 技能点+2重分配 - 約 40YB
	eIncantation_SkPointRedist_4 = 55323,    // 技能点+4重分配 - 約 60YB
	eIncantation_SkPointRedist = 55300,      // 技能点重分配 - 約 30YB
	eIncantation_ShowPyoguk = 55351,         // 仓库显示符 - 約 20G
	eIncantation_ShowPyoguk7 = 57506,        // 仓库显示符（7天） - 約 50G
	eIncantation_ShowPyoguk7_NoTrade = 57507,// 仓库显示符（7天不可交易） - 約 40G
	eIncantation_ChangeName = 55352,         // 改名卡 - 約 100YB
	eIncantation_Tracking = 55353,           // 角色追踪 - 約 20G
	eIncantation_Tracking7 = 57504,          // 角色追踪（7天） - 約 40G
	eIncantation_Tracking7_NoTrade = 57505,  // 角色追踪（7天不可交易） - 約 30G
	eIncantation_Tracking_Jin = 55387,       // 角色追踪（Jin） - 約 40G
	eIncantation_CharChange = 55354,         // 更换角色 - 約 80YB
	eIncantation_ShapeChange = 55355,        // 外观变更符 - 約 60YB
	eIncantation_ItemSeal = 55356,           // 道具封印符 - 約 30YB
	eIncantation_ProtectAll15 = 55358,       // 全保护符（15次） - 約 300G
	eIncantation_ChangeJob = 55360,          // 职业转换符 - 約 120YB
	eIncantation_MugongExtend = 55361,       // 武功扩展符 - 約 50YB
	eIncantation_MugongExtend2 = 57957,      // 武功扩展符2 - 約 80YB
	...
	eIncantation_PetRevival = 55382,         // 宠物复活符 - 約 25G
	eIncantation_PetGrade2 = 55384,          // 宠物二阶符 - 約 50YB
	eIncantation_PetGrade3 = 55385,          // 宠物三阶符 - 約 80YB
	eIncantation_MugongOptionReset = 55387,  // 武功选项重置 - 約 60YB
	eIncantation_PyogukExtend = 57544,       // 仓库扩展 - 約 40G
	eIncantation_PyogukExtend2 = 57960,      // 仓库扩展2 - 約 60G
	eIncantation_CharacterSlot = 57543,      // 角色栏扩展 - 約 80YB
	eIncantation_CharacterSlot2 = 57959,     // 角色栏扩展2 - 約 120YB
	eIncantation_InvenExtend = 57542,        // 背包扩展 - 約 50YB
	eIncantation_InvenExtend2 = 57958,       // 背包扩展2 - 約 80YB
	eIncantation_ChangeName_Dntrade = 57799, // 改名卡（不可交易） - 約 80YB
	eIncantation_Curse_Cancellation = 55389, // 诅咒解除符 - 約 20G
	eSundries_Boom_Butterfly = 55621,        // 烟花（蝴蝶） - 約 5G
	eSundries_Boom_Star = 55622,             // 烟花（星星） - 約 5G
	eSundries_ScreenShout = 55627,           // 屏幕喊话符 - 約 10G
	eSundries_ScreenShout_Once = 55628,      // 屏幕喊话（1次） - 約 3G
	eSundries_SuperShout = 55629,            // 超级喊话 - 約 20G
	eSundries_SuperShout_Once = 55630,       // 超级喊话（1次） - 約 5G
...
enum
{
	eShopItemUseParam_Realtime = 1,				
	eShopItemUseParam_Playtime = 2,				
	eShopItemUseParam_Continue = 3,				
	eShopItemUseParam_Forever = 4,				
	eShopItemuseParam_FBItem = 5,
	eShopItemUseParam_EquipAvatar = 10,			
};
enum
{
	eStateItem_NotUsed,
...
enum eFortWarEngraveError
{
	...
	eFortWarEngraveError_AlreadyMaster,
};
...
#define EVERYGOLDMONEY      500              
#define EVERYGOLDTIME		14400            
...
enum {
	eDungeonERR_None			= 0,	
	eDungeonERR_NoKeyInfo		= 1,	
	eDungeonERR_NoParty			= 2,	
	eDungeonERR_NotEnoughLevel	= 3,	
	eDungeonERR_OverLevel		= 4,	
	eDungeonERR_EntranceDelay	= 5,	
	eDungeonERR_OverCount		= 6,	
	eDungeonERR_DungeonMapOff	= 7,	
	eDungeonERR_DungeonFull		= 8,	
	eDungeonERR_NoNPCInfo		= 9,	
	eDungeonERR_WrongParam		= 10,	
	eDungeonERR_NoChannel		= 11,	
	eDungeonERR_WrongDiffculty	= 12,	
...
enum eINSDG_TYPE
{
	eINSDG_TYPE_PARTY = 0,		//颇萍
	eINSDG_TYPE_MUNPA,		//巩颇
};

//牢带 涝厘 俊矾 贸府 惑荐
enum eINSDG_ENTRANCE_ERROR
{
	eINSDG_ENTRANCE_ERROR_NONE = 0,	//沥惑
	eINSDG_ENTRANCE_ERROR_NULL,		//NULL蔼 俊矾
	eINSDG_ENTRANCE_ERROR_FAIL,		//涝厘 角菩 坷幅
	eINSDG_ENTRANCE_ERROR_LEVEL,		//饭骇 坷幅
	eINSDG_ENTRANCE_ERROR_QUEST,		//涅胶飘 坷幅
	eINSDG_ENTRANCE_ERROR_ITEM,		//酒捞牌 坷幅
	eINSDG_ENTRANCE_ERROR_MONEY,		//家瘤陛 坷幅
	eINSDG_ENTRANCE_ERROR_MISSION,		//固记 坷幅
	eINSDG_ENTRANCE_ERROR_MOVEMAP,		//涝厘且 甘 包访 坷幅
	eINSDG_ENTRANCE_ERROR_PARTY,		//颇萍 绝阑矫 坷幅
	eINSDG_ENTRANCE_ERROR_MUNPA,		//巩颇啊 绝阑矫 坷幅
	eINSDG_ENTRANCE_ERROR_CLEAR,		//牢带 努府绢
};
