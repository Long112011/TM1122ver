...
enum UPDATE_BIT{ UB_DBIDX = 1, UB_ICONIDX=2, UB_ABSPOS=4, UB_QABSPOS=8, UB_DURA=16, UB_RARE=32,UB_STONE=64,UB_LOCK=128,UB_UNLOCK=256,UB_GROW=512,UB_POWERUP=1024,UB_GREEN=2048, UB_ALL=4096, };  // 2014-11-14 
...
public:
	...
	virtual ERROR_ITEM UpdateItemAbs(CPlayer * pPlayer, POSTYPE whatAbsPos, DWORD dwDBIdx, WORD wItemIdx, POSTYPE position, POSTYPE quickPosition, DURTYPE Dur, WORD flag=UB_ALL, WORD state=SS_NONE, DWORD RareDBIdx = 0, DWORD StoneIdx=0,DWORD Grow=0,char * PowerUp="NULL",char * Green = "NULL");
