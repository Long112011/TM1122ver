...
cShopItemInventPlusDlg::cShopItemInventPlusDlg(void)
{
	...
	//GAMEIN->GetInventoryDialog()->GetShopInvenPlus()->SetDisableIcon(0,40);
}
...
{
	return (TP_SHOPINVEN_START+TABCELL_SHOPINVEN_NUM<=absPos&&absPos<TP_SHOPINVEN_END);
}
...
{
	return ( absPos - (TP_SHOPINVEN_START+TABCELL_SHOPINVEN_NUM) ) % (40+TABCELL_SHOPINVEN_NUM)/*80*/;
}
