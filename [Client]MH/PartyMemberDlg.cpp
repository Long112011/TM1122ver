...
void CPartyMemberDlg::Render()
{
...

	{
		...
		if( m_bOption )
		{
			this->SetAbsXY( (LONG)x, (LONG)(y+134 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pName->SetAbsXY( (LONG)(x+9), (LONG)(y+148 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pLife->SetAbsXY( (LONG)(x+6), (LONG)(y+168 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pNaeryuk->SetAbsXY( (LONG)(x+6), (LONG)(y+174 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pLevel->SetAbsXY( (LONG)(x+9), (LONG)(y+135 + ( 48 * m_nIndex ))-m_nMinusIndex );
		}
		else

		{

			this->SetAbsXY( (LONG)x, (LONG)(y + 54 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pName->SetAbsXY( (LONG)(x+9), (LONG)(y + 68 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pLife->SetAbsXY( (LONG)(x+6), (LONG)(y + 88 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pNaeryuk->SetAbsXY( (LONG)(x+6), (LONG)(y + 94 + ( 48 * m_nIndex ))-m_nMinusIndex );
			m_pLevel->SetAbsXY( (LONG)(x+9), (LONG)(y + 55 + ( 48 * m_nIndex ))-m_nMinusIndex );
		}
	}
