...
public:
	...
	BOOL CollisionCheck_OneLine(VECTOR3* p_pStart, VECTOR3* p_pEnd, VECTOR3* p_pRtCollisonPos);
...
public:
	...
	CTile*	GetNode4x(DWORD p_PosX, DWORD p_PosY);
	CTile*	GetNode4x(float p_PosX, float p_PosY);
	...
	BOOL FindClosest4xTile(const VECTOR3& p_Position, IPathNode*& p_ClosestNode);
