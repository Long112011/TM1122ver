...
bool CheckRenewal()
{
	...
	int year = currentTime->tm_year + 1900;  // tm_year ÊÇ´Ó1900Äê¿ªÊ¼¼ÆÊý
	int month = currentTime->tm_mon + 1;     // tm_mon ·¶Î§ÊÇ 0-11£¬1ÔÂÎª0
	int day = currentTime->tm_mday;

	// ±È½Ïµ±Ç°ÈÕÆÚºÍÐø·Ñ½ØÖ¹ÈÕÆÚ
	...
	{
		MessageBox(NULL, "ÒÑ¹ýÆÚ£¬ÇëÁªÏµÌìÄ«¼¼ÊõÍÅ¶ÓÑÓ³¤Ê±¼ä¡£¡¾FB ;¿ñÈË¼¼ÊõÍÅ¶Ó¡¿ ¡¾Discord £ºtianmo1122¡¿", "°æ±¾¹ýÆÚ", MB_OK);
		return false;  // ·µ»Ø false£¬±íÊ¾ÐèÒª¹Ø±Õ
	}

	return true;  // ·µ»Ø true£¬±íÊ¾¿ÉÒÔ¼ÌÐøÔËÐÐ
}
