...
//#include "GameAIManager.h"   //weiye 땍屢코밈庫匡숭 2017-12-05
#include "AIManager.h"
...
CPlayer::CPlayer()
{
	...
	InitSkinDelayTime();
	m_NameImg=0;                //weiye 칵훰청唐냔뵀暠튬 2018-04-21
}
...
WORD CPlayer::GetWeaponEquipType()//삿혤뎠품嶠포角痂척蘆잚
{
...
//2008. 1. 21. CBH - 스킨 레이 관련 함수
void CPlayer::InitSkinDelayTime()
{
	m_dwSkinDelayTime = 0;	//레이 총 시간 변수
	m_bSkinDelayResult = FALSE;	//레이중인지 체크하는 변수
}
