...
public:
	...
	void SetAnimateRate(float nRate) { m_AnimateRate = nRate; }
	//////////////////////////////////////////////////////////////////////////
	// link
...
//	
	...
	friend CObjectBase* GetSelectedObject(int MouseX,int MouseY,int PickOption = PICK_TYPE_PER_COLLISION_MESH);
