...
enum EXECUTIVE_PICKING_MODE
{
	...
	PICKING_MODE_TOOL		= 1					// Picking 안되는 성에 상관없이 picking되게 한다. 
};
///
...
struct DECAL_DESC
{
	...
	VECTOR3			v3XYZScale;					// 각 성분의 길이. 왼손 좌표계 기준으로 데칼의 오른이 X, 윗이 Z, 화면방향이 Y.
	BOOL			bLookAtPivot;
	//	void*			MaterialHandle;
