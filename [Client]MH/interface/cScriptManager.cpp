...
{
	m_ImageNamePath.Initialize(2000);//狂人称号
	m_ImageNameInfo.Initialize(2000); //狂人称号
...
{	
	...
	case eShopItemInventPlusDlg:
		{//[ShopInventoryPlus][By:十里坡剑传奇][QQ:112582793][2018/10/9]
