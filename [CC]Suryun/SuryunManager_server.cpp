...
void CSuryunManager::OnGoSuryunSyn(CPlayer* pPlayer,WORD MugongIdx)
{
	...
	if( sung == 11 || sung == 6 )
	{
		...
		MUGONGBASE* pInfo = pPlayer->GetMugongBaseByMugongIdx(MugongIdx);
		if( pInfo->ExpPoint < maxpoint - 2 )
			OnError( 1, 1, OnGoSuryunSyn_NACK );
	}
	//	
	...
	ySWITCH(Protocol)
		...
		yCASE(MP_SURYUN_ENTER_SYN)
			...
			pPlayer->SetInitState(
				...
				PLAYERINITSTATE_ITEM_STONE_INFO |    // 2014-11-15 
...
// MP_USERCONN_GAMEIN_SYN¿¡¼­ Ã³·³ questÁ¤º¸ ¾ò±â....(jsd04.09.16)
