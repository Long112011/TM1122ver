...
// Declare an instance of CColorButton for each static text being modified.
// Ex. CColorButton m_stText;
//
// In your OnInitDialog() add a SubclassDlgItem for each CColorButton member variable.
...
CColorButton::CColorButton()
{
	...
	m_crTextColor = WHITE; // Initializing the text to Black
