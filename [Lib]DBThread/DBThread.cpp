...
{
	InitializeCriticalSectionAndSpinCount(&m_DBCS,200);           //weiye 2015-01-25 数据库线程初始化，之前200, 现在设置为500个数据库并发连接
	InitializeCriticalSectionAndSpinCount(&m_ReturnMessage,200);  //weiye 2015-01-25 数据库线程初始化，之前200, 现在设置为500个数据库并发连接
