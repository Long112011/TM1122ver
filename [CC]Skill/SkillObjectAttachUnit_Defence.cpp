...
/*
불침지체	
maintain_Sresist01_S.beff	화성 불침지체
maintain_Sresist02_S.beff	수성 불침지체
maintain_Sresist03_S.beff	목성 불침지체
maintain_Sresist04_S.beff	금성 불침지체
maintain_Sresist05_S.beff	토성 불침지체
*/
		ySWITCH(m_Attrib)
...
/*
저항력 상승	
maintain_resist01_S.beff	화성 저항력 상승
maintain_resist02_S.beff	수성 저항력 상승
maintain_resist03_S.beff	목성 저항력 상승
maintain_resist04_S.beff	금성 저항력 상승
maintain_resist05_S.beff	토성 저항력 상승
maintain_resist06_S.beff	무성 저항력 상승
*/
		ySWITCH(m_Attrib)
			yCASE(ATTR_FIRE)	m_AttachEffectNum[0] = pSkillInfo->GetSkillInfo()->EffectMineOperate;
								m_StateIconNum[0] = eStatusIcon_AttrDefenceFire;
