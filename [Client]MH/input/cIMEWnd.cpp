...
#include "CharConvert.h"  //Encoding conversion header file 2018-05-10
	...
	case WM_IME_CHAR:
		{
			...
			if( m_pDockingEx->IsValidChar( (unsigned char*)szChar ) )
			{	
				//Automatically convert input method codes 2018-05-10
				//Here, each character is processed and transcoded
				//according to the system encoding 2018-05-10
			//	if(GetANSICode()==936) //If it is Taiwan, Hong Kong, Traditional Chinese area 2018-05-10
			//	{
			//		SafeStrCpy(szChar,GB2312ToBIG5(szChar),3);
			//	}
...
//Automatic judgment function of game internal code 2018-05-10
UINT cIMEWnd::GetANSICode()
{
	return GetACP();
}