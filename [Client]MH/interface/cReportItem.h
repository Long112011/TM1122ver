...
public:
	...
	void Create(int nMaxCols)
	{
		...
		PColumnHeaderImg=new cImage[m_Cols];
		...
		memset(PColumnHeaderImg,0,sizeof(cImage)*m_Cols);
	}
	...
	void InsertColoumnHeaderImg(WORD nCol,cImage * pheaderImg=NULL)
	{
		PColumnHeaderImg[nCol]=*pheaderImg;
	}
	void InsertColoumn(WORD nCol, char * szColumnHeading, WORD wColumnSize/*, DWORD fgcolor=RGB_HALF(255,255,255)*/)
	{
		...
		pColumnTextColor[nCol] = RGB_HALF(0,255,0);
