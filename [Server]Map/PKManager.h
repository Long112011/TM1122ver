...
public:
	...
	void SetPKAllow(DWORD dwChannel,BOOL PkModel){m_bPKAllow[dwChannel-1]=PkModel;} //miningmso 设置线路开红状态 2018-12-28

	BOOL IsPKAllow( DWORD dwChannel )   //miningmso 获取线路开红状态 2018-12-28
	{
		if( dwChannel < 1 )
			dwChannel = 1;
