...
public:
	...
	DWORD PutSkinSelectLook(MSG_DWORD7* pMsg);
	DWORD PutSkinSelectItemNew(MSG_DWORD7_SKIN pMsg);
	...
	CYHHashTable<SHOPITEMWITHTIME> * GetUsingItemInfoAll();  // 2014-11-10  ªÒ»°Ω«…´‘ˆ“Ê–≈œ¢

	BOOL IsCanInPutFBMap();
