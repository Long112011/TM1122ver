...
public:
	...
	void SetFortName(char* nickname);
	...
	BOOL RenderFort(LONG absX, LONG absY, BYTE kind);
	...
	LONG GetFortPosX() { return m_lFortPosX; }
	LONG GetFortTall() { return m_lFortTall; }
	void SetFortPosX(LONG	pos);
