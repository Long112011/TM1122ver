...
#ifdef  _MUTIPET_
	pPlayer->GetPetManager()->GetPetBuffResultRt(ePB_MaxLifeNaeRyukShield, &MaxLife);//µ¶¸ç  3pet
#endif //  _MUTIPET_
...
#ifdef  _MUTIPET_
	pPlayer->GetPetManager()->GetPetBuffResultRt(ePB_MaxLifeNaeRyukShield, &MaxShield);//µ¶¸ç  3pet
#endif //  _MUTIPET_
...
#ifdef  _MUTIPET_
	pPlayer->GetPetManager()->GetPetBuffResultRt(ePB_MaxLifeNaeRyukShield, &MaxEnergy);//µ¶¸ç   3pet
#endif //  _MUTIPET_
