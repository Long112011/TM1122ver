...
//	void GetExtraItemToolTip(char * tooltip, int lens, ITEM_INFO * pInfo);
	...
	void SetEquipItemToolTip( cIcon * pIcon, ITEM_INFO * pInfo, ITEM_OPTION_INFO * pOptionInfo=NULL, ITEM_RARE_OPTION_INFO* pRareOptionInfo=NULL,ITEM_STONE_OPTION_INFO * pShoneOptionInfo=NULL,BOOL bIsQuey=FALSE);
