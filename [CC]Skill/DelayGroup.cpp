...
CDelayGroup::CDelayGroup()
{
	...
	m_DelayedTable.Initialize(24);//16

	m_pTitanPotionDelay = NULL;

	m_pYoungYakPotionDelay[0] = NULL;
	m_pYoungYakPotionDelay[1] = NULL;
	m_pYoungYakPotionDelay[2] = NULL;
	m_pYoungYakPotionDelay[3] = NULL;
	m_pYoungYakPotionDelay[4] = NULL;
	m_pYoungYakPotionDelay[5] = NULL;
	m_pYoungYakPotionDelay[6] = NULL;
	m_pYoungYakPotionDelay[7] = NULL;
}
...
#ifdef _MAPSERVER_
	//2007. 11. 15. CBH - 무공 레이 버그 관련 수정
	//클라이언트에서 레이가 풀리고 바로 무공을 쓰면 서버에서는 이전 무공의 레이가 끝나지 않아서
