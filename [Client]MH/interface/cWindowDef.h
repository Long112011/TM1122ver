...
#define MAX_TOOLTIPSTR_SIZE		256		//KES. ºýºýÇÏ´Ù.. 
...
#define LINE_HEIGHT				15    //weiye tooltip Ä¬ÈÏ¸ß¶ÈÉèÖÃÎª20 2018-01-14
...
//ÅøÆÁ ±Û¾¾
#define TTTC_DEFAULT			RGB_HALF(255,255,255)   //2DÍ¼
#define TTTC_MUGONGNAME			TTTC_DEFAULT
#define TTTC_EXTRAATTR			RGB_HALF(135, 206, 250)		//+¸Ó¸Ó¸Ó(%)
#define TTTC_EXTRAATTRITEM		TTTC_EXTRAATTR					//°Ë+1µî ¼º°¡Áø ¾ÆÀÌÅÛ
#define TTTC_RAREITEM			RGB_HALF( 85, 252, 85 )		//!ÀÓ½Ã ·¹¾î ¾ÆÀÌÅÛ 
#define TTTC_NUMBER				RGB_HALF(84, 143, 223 )		//°ø°Ý·Â 0~0
#define TTTC_LIMIT				RGB_HALF( 230, 20,  20 )		//·¹º§0ºÎÅÍ»ç¿ë
#define TTTC_FREELIMIT			TTTC_DEFAULT					//·¹º§Á¦ÇÑ Ç®¸²
#define TTTC_MUGONGBOOKKIND		RGB_HALF( 230, 232, 38 )		//°Ë¿Ü°ø¼­
#define TTTC_MUGONGKIND			RGB_HALF( 230, 232, 38 )		//¿Ü°ø, ³»°øµî
#define TTTC_MUGONGEXP			RGB_HALF( 230, 232, 38 )		//¹«°ø°æÇèÄ¡
#define TTTC_MUGONGNEEDMANA		RGB_HALF( 230, 232, 38 )		//ÇÊ¿ä¸¶³ª
#define TTTC_MUGONGATTRKIND		TTTC_EXTRAATTR					//¹«°ø¼Û¼®Á¾·ù(È­¼º)
#define TTTC_EXTRAITEM			TTTC_DEFAULT
#define TTTC_BUYPRICE			RGB_HALF( 135, 206, 250 )				//×°±¸ÏÔÊ¾¼Û¸ñÑÕÉ« 2018-05-13
...
#define TTTC_ABILITYEXP			TTTC_BUYPRICE			//¿ä±¸¼ö·ÃÄ¡
...
#define TTTC_ITEMGROW					RGB_HALF( 255, 215, 0)   // ÏµÍ³ 2015-01-14
#define TTTC_ITEM_LEVEL				RGB_HALF(255, 255, 200)   //weiye ×°±¸ÀàÐÍºÍ¼¶±ð 2018-01-27
#define TTTC_ITEM_GROW				RGB_HALF(0, 255, 255)    //weiye  ³É³¤ÑÕÉ«¶¨Òå  2018-01-18

#define TTTC_ITEM_PINK					RGB_HALF(255,212,234)
...
//	WT_DIVIDEBOX,
	...
	WT_MUGONG, WT_JINBUB,
	WT_ITEM, WT_QUICKITEM, WT_STALLITEM,WT_SHOPITEM,WT_SHOPGOLDITEM,
	WT_EXCHANGEITEM,
	WT_DEALITEM,
	WT_ABILITYICON,
	WT_VIRTUALITEM,
...
//	WT_MUNPAWAREHOUSEDLG = 1029,
    ...
    // the type define 2014-08-11
	WT_MINIMARYDLG,
	WT_SHOWCHARACTORLISTDLG,
	WT_SHOWEQUIPDLG,
	WT_LIMITMAPGOTODLG,
	WT_MINIBAISHIDLG,
	WT_GODLSHOP_DLG,
