...
void CSkillInfo::SendMsgToServer(CHero* pOperator,CActionTarget* pTarget)
{
	...
	{
		char str[256] ={0,};
		sprintf( str, "SkillIndex = %d的范围超出.", wSkillIndex );
		WRITEDEBUGFILE( str );
		return;
	}*/
	...
	{
		char str[256] ={0,};
		sprintf( str, "SkillIndex = %d 技(%s)使用无效.", wSkillIndex, m_SkillInfo.SkillName );
		WRITEDEBUGFILE( str );
	}*/
