...
public:
	...
	CMonster* RegenObjectForGMTool(DWORD dwID, DWORD dwSubID, DWORD dwGridID, WORD wObjectKind, WORD wMonsterKind, VECTOR3 * vPos, DWORD dwGroupID, WORD DropItemID = 0, DWORD dwDropRatio = 100 ,BOOL bRandomPos = TRUE, BOOL bEventRegen = FALSE);
};
