...
//for linking
	...
	DWORD			    m_dwGold;      //  2014-10-29
	DWORD				m_dwOpGold;    //  2014-10-29
...
//	virtual DWORD ActionEvent( CMouse* mouseInfo, CKeyboard* keyInfo );
	...
	void DelItemStoneOptionInfo(POSTYPE pos); // 2014-12-15 
	void DelItemStoneOptionAll();             // 2014-12-15 »´≤ø

	DWORD InputMoney( int nType, DWORD dwMoney );

	DWORD InputGold( int nType, DWORD dwGold );  //  ‰»Î 2014-10-29
