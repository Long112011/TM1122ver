...
static COLORREF ColorTable[16] = { RGB(  34,   34,   34),		// Black
...
void CXListBox::AppendList(int i, char*str)
{
	CXListBox::Color textColor;
	CXListBox::Color backColor;
	if (theApp.GetGameAI()->sPage1.DarkMode)
	{
		textColor = CXListBox::White;
		backColor = CXListBox::Black;
	}
	else
	{
		textColor = CXListBox::Black;
		backColor = CXListBox::White;
	}
	if (i == TRUE)
	{
		AddLine(textColor, backColor, str);
	}
	else
	{
		AddLine(CXListBox::Red, backColor, str);
	}
}
//=============================================================================	
...
//=============================================================================	
{
	return AddLine(CXListBox::White, CXListBox::Black, lpszItem);
}
...
{
	ResetContent();
	::SendMessage(m_DialogHwnd, WM_CONTROLCLEARLIST, 0, 0);
}
