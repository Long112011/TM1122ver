...
void CFWEngraveDialog::Linking()
{
	...
	//m_pCancelBtn = (cButton*)GetWindowForID(FW_ENGRAVECANCEL);

	((cButton*)((cDialog*)this)->GetWindowForID(FW_ENGRAVECANCEL))->SetText("",RGB(10,10,10));
	((cButton*)((cDialog*)this)->GetWindowForID(FW_ENGRAVECANCEL))->SetAlpha(0);
	((cButton*)((cDialog*)this)->GetWindowForID(FW_ENGRAVECANCEL))->SetDisable(TRUE);
}
