...
void CBattle_MurimField::Victory( int WinnerTeamNum, int LoserTeamNum )
{
	...
	// 
	m_vImagePos.x = ((float)GAMERESRCMNGR->m_GameDesc.dispInfo.dwWidth - 128 * m_vImageScale.x ) / 2;	//128 = width
	m_vImagePos.y = ((float)GAMERESRCMNGR->m_GameDesc.dispInfo.dwHeight - 42 * m_vImageScale.y ) / 2;		//42 = height
