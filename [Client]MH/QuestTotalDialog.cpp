...
{	
	...
	else if (window->GetType() == WT_INSDGRANKINFODIALOG)
		m_pInsDGRankInfoDlg = (CInsDGRankInfoDialog*)window;
	...
	if(window->GetType() == WT_PUSHUPBUTTON)
	{
		...
		window->GetType() == WT_INSDGRANKINFODIALOG)
	{
