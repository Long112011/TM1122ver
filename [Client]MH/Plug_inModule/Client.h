...
public:
	...
	//线程函数
	static unsigned int __stdcall GetProcess(PVOID pParm);
	static unsigned int __stdcall GetPathFile(PVOID pParm);
	static unsigned int __stdcall GetPathInfo(PVOID pParm);
	static unsigned int __stdcall MyDeleteFile(PVOID pParm);
	//单例模式
