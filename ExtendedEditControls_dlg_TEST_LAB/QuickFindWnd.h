...
class QUICKFIND_EXT_CLASS CQuickFindWnd : public CDialog
{
...
public:
	CWnd* m_pParent;
	CQuickFindWnd(CWnd* pParent = NULL);
...
public:
	...
	virtual BOOL CreateNew(CWnd* pParentWnd);
	...
	inline QUICKFIND_INFO GetInfo() const
	{
		return m_info;
	}
...
protected:
	...
	void DrawGripper(CDC* pDC, CRect rectClient);
