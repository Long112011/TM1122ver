...
void CExchangeRoom::Init( CPlayer* pPlayer1, CPlayer* pPlayer2 )
{
	...
	m_ExchangeData[0].dwGold		= 0; // 2014-10-29 鑒좆
	...
	m_ExchangeData[1].dwGold		= 0; // 2014-10-29 鑒좆
